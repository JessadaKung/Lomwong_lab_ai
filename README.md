...
ดู thinking process ของ Lab 4 ได้ที่ [docs/PIVOT.md](docs/PIVOT.md)

## Features

- ตอบ FAQ ของร้านจาก `data/knowledge/lomwong_cafe_kb.txt`
...
- `app.py` — entrypoint สั้น ๆ สำหรับ Streamlit/Hugging Face
- `src/lomwong_ai/app.py` — Streamlit UI สำหรับถามโมจิและสั่งอาหาร
- `src/lomwong_ai/rag_engine.py` — load, chunk, embed, index, search ด้วย Sentence Transformers + FAISS
- `src/lomwong_ai/menu_catalog.py` — รายการเมนูและราคา สำหรับระบบสั่งอาหาร
- `src/lomwong_ai/order_logger.py` — บันทึกออเดอร์และรายรับลง Google Sheets
- `src/lomwong_ai/telegram_report.py` — ส่งแจ้งเตือนออเดอร์และรายงานยอดขายเข้า Telegram
- `data/knowledge/lomwong_cafe_kb.txt` — knowledge base ของ Lomwong Cafe
- `docs/PIVOT.md` — Lab 4 Pivot Worksheet
